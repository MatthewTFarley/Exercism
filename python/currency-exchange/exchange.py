"""
The Exchange module provides functionas for converting between currencies
"""
...
def exchangeable_value(budget: float, exchange_rate: float, spread: int, denomination: int) -> int:
    ...
    return raw_exchange_value(budget, exchange_rate, spread) // denomination * denomination
...
def non_exchangeable_value(budget: float, exchange_rate: float, spread: int, denomination: int) -> int:
    ...
    return raw_exchange_value(budget, exchange_rate, spread) % denomination


def raw_exchange_value(budget: float, exchange_rate: float, spread: int) -> int:
    """
    ...
    return int(exchange_money(budget, exchange_rate + exchange_rate * (spread / 100)))
